...
class ProductConcreteManagerTest extends ProductTestAbstract
{
    ...
    public function testSaveProductConcreteShouldUpdateProductAndTriggerPlugins()
    {
        ...
        $productQuantityTransfer->setFkProduct($this->productConcreteTransfer->getIdProductConcrete())
            ->setQuantityMin(1)
            ->setQuantityInterval(1);
        $this->productConcreteTransfer->setProductQuantity($productQuantityTransfer);
