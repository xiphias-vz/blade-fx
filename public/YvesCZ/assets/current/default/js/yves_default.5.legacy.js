...
var ImageGallery = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inheritsLoose__WEBPACK_IMPORTED_MODULE_4___default()(ImageGallery, _Component);
  ...
  function ImageGallery() {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_1___default()(_this), "galleryItems", void 0);
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_1___default()(_this), "thumbnail", void 0);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_1___default()(_this), "thumbnailItems", void 0);
  ...
  _proto.mapEvents = function mapEvents() {
    ...
    if (this.thumbnail) {
      this.thumbnail.addEventListener('click', function (event) {
        return _this2.onThumbnailHover(event);
      }, true);
    }
  };

  _proto.addHeightToTheImg = function addHeightToTheImg() {
    this.image.setAttribute('style', 'height: auto !important');
  };

  _proto.initSlider = function initSlider() {
    if (window.matchMedia('(max-width: 768px)').matches) {
      jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_7___default()(".slick-track").css({
        "transform": "translate3d(0px, 0px, 0px)"
      });
      this.mobileViewSetPreviewImage();
    } else {
      jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_7___default()("#mobile-slider").css("display", "none");
    }

    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_7___default()(this.thumbnail).slick(this.thumbnailSliderConfig);
  };

  _proto.onThumbnailHover = function onThumbnailHover(event) {
  ...
  _proto.thumbnailChange = function thumbnailChange(thumbnail) {
    var _this3 = this;
    ...
    if (!thumbnail.classList.contains(this.thumbnailActiveClass)) {
      ...
      allItems.forEach(function (thumbnailItem) {
        return thumbnailItem.classList.remove(_this3.thumbnailActiveClass);
      });
  ...
  _proto.setActiveImage = function setActiveImage(activeItemIndex) {
    var _this4 = this;

    var allGalleryItems = Array.from(this.getElementsByClassName(this.jsName + "__item"));
    allGalleryItems.forEach(function (galleryItem) {
      return galleryItem.classList.remove(_this4.activeClass);
    });
    this.galleryItems[activeItemIndex].classList.add(this.activeClass);
    this.mobileViewSetPreviewImage();
  };

  _proto.mobileViewSetPreviewImage = function mobileViewSetPreviewImage() {
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_7___default()("#mobile-slider").empty();
    var find = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_7___default()(".image-gallery-thumbnail__item.js-image-gallery-thumbnail__item.image-gallery-thumbnail__item--active")[0];
    ...
    var activeSource = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_7___default()(find).clone();
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_7___default()(activeSource[0]).removeClass("image-gallery-thumbnail__item");
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_7___default()(activeSource[0]).removeClass("js-image-gallery-thumbnail__item");
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_7___default()(activeSource[0]).removeClass("image-gallery-thumbnail__item--active");
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_7___default()("#mobile-slider").append(activeSource);
  };

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_0___default()(ImageGallery, [{
    key: "activeClass",
    get: function get() {
      return this.getAttribute('active-class');
    }
  }, {
    key: "thumbnailSliderConfig",
    get: function get() {
      return JSON.parse(this.getAttribute('slider-config'));
    }
  }, {
    key: "thumbnailActiveClass",
    get: function get() {
