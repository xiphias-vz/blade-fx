...
class ImageGallery extends ShopUi_models_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super(...arguments);

    _defineProperty(this, "galleryItems", void 0);

    _defineProperty(this, "image", void 0);

    _defineProperty(this, "thumbnail", void 0);

    _defineProperty(this, "thumbnailItems", void 0);
  }
  ...
  mapEvents() {
    if (this.thumbnail) {
      this.thumbnail.addEventListener('click', event => this.onThumbnailHover(event), true);
    }
  }
  ...
  initSlider() {
    if (window.matchMedia('(max-width: 768px)').matches) {
      jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()(".slick-track").css({
        "transform": "translate3d(0px, 0px, 0px)"
      });
      this.mobileViewSetPreviewImage();
    } else {
      jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()("#mobile-slider").css("display", "none");
    }

    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()(this.thumbnail).slick(this.thumbnailSliderConfig);
  }
  ...
  thumbnailChange(thumbnail) {
    var index = Number(thumbnail.dataset.thumbnailIndex);

    if (!thumbnail.classList.contains(this.thumbnailActiveClass)) {
      var allItems = Array.from(this.getElementsByClassName(this.jsName + "-thumbnail__item"));
  ...
  setActiveImage(activeItemIndex) {
    var allGalleryItems = Array.from(this.getElementsByClassName(this.jsName + "__item"));
  ...
  mobileViewSetPreviewImage() {
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()("#mobile-slider").empty();
    var find = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()(".image-gallery-thumbnail__item.js-image-gallery-thumbnail__item.image-gallery-thumbnail__item--active")[0];
    ...
    var activeSource = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()(find).clone();
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()(activeSource[0]).removeClass("image-gallery-thumbnail__item");
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()(activeSource[0]).removeClass("js-image-gallery-thumbnail__item");
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()(activeSource[0]).removeClass("image-gallery-thumbnail__item--active");
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()("#mobile-slider").append(activeSource);
  }
