...
class SlickCarousel extends ShopUi_models_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    _defineProperty(this, "customSelects", void 0);

    _defineProperty(this, "initTriggers", void 0);

    _defineProperty(this, "listSwitcher", void 0);
  }
  ...
  initializeSliderByCustomEvent() {
    this.listSwitcher.addEventListener(EVENT_TOGGLE_FORM, event => {
      if (this.container.classList.contains('slick-initialized')) {
        return;
      }

      var targetContainer = this.getElementsByClassName(event.detail.targetClass)[0];
      this.initialize(targetContainer);
    });
  }

  initialize(container) {
    var $container = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()(container);
    $container.on('init', () => {
