...
var SlickCarousel = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inheritsLoose__WEBPACK_IMPORTED_MODULE_4___default()(SlickCarousel, _Component);

  var _super = _createSuper(SlickCarousel);
  ...
  function SlickCarousel() {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_1___default()(_this), "customSelects", void 0);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_1___default()(_this), "initTriggers", void 0);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_1___default()(_this), "listSwitcher", void 0);
  ...
  _proto.init = function init() {
    ...
    this.listSwitcher = document.getElementsByClassName('list-switches')[0];
  ...
  _proto.initializeSliderByCustomEvent = function initializeSliderByCustomEvent() {
    var _this2 = this;

    this.listSwitcher.addEventListener(EVENT_TOGGLE_FORM, function (event) {
      if (_this2.container.classList.contains('slick-initialized')) {
        return;
      }

      var targetContainer = _this2.getElementsByClassName(event.detail.targetClass)[0];

      _this2.initialize(targetContainer);
    });
  };

  _proto.initialize = function initialize(container) {
    var _this3 = this;

    var $container = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_7___default()(container);
    ...
    $container.slick(this.sliderConfig);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_0___default()(SlickCarousel, [{
