 ...
 */
class SendOrderCancelledEmailCommandByOrderPlugin extends AbstractPlugin implements CommandByOrderInterface
{
    /**
     * @api
     *
    ...
    {
        $this->getFacade()->sendOrderCancelledMail($orderEntity);
