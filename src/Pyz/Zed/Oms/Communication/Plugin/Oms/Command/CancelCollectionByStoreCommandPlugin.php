 ...
 */
class CancelCollectionByStoreCommandPlugin extends AbstractPlugin implements CommandByOrderInterface
{
    /**
     * @api
     *
    ...
    public function run(array $orderItems, SpySalesOrder $orderEntity, ReadOnlyArrayObject $data): array
    {
        ...
        if ($this->getFacade()->isOrderFlaggedCancelled($idSalesOrder)) {
            $orderUpdateRequestTransfer = (new OrderUpdateRequestTransfer())
                ->setStoreStatus(OmsConfig::STORE_STATE_COLLECTION_CANCELLED_BY_STORE);
