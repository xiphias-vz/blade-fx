 ...
 */
class OrderCancelledByCustomerCommandByOrderPlugin extends AbstractPlugin implements CommandByOrderInterface
{
    /**
     * @api
     *
    ...
    public function run(array $orderItems, SpySalesOrder $orderEntity, ReadOnlyArrayObject $data)
    {
        $orderUpdateRequestTransfer = (new OrderUpdateRequestTransfer())
            ->setStoreStatus(OmsConfig::STATE_CANCELLED_BY_CUSTOMER);
