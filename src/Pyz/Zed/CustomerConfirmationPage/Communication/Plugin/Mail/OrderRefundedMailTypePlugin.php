...
class OrderRefundedMailTypePlugin extends AbstractPlugin implements MailTypePluginInterface
{
    public const MAIL_TYPE = 'order refunded';
    public const MAIL_ORDER_REFUNDED_SUBJECT = 'mail.order-refunded.subject';
    ...
    {
        $mailBuilder->setSubject(static::MAIL_ORDER_REFUNDED_SUBJECT);
