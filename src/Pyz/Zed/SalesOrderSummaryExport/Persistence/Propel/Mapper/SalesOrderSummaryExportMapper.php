...
namespace Pyz\Zed\SalesOrderSummaryExport\Persistence\Propel\Mapper;

class SalesOrderSummaryExportMapper
{
    /**
     * @var array
     */
    protected $fieldMapping = [
        'my_globus_card' => 'my_globus_card',
        'itemsCount' => 'itemsCount',
        'order_totals_order_expense_total' => 'order_totals_order_expense_total',
        'Delivered_ItemsCount' => 'Delivered_ItemsCount',
