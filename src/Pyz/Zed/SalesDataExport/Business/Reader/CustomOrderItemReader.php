...
class CustomOrderItemReader implements ReaderInterface
{
    /**
    ...
    {
        return $this->salesDataExportRepository->getCustomOrderItemData($dataExportConfigurationTransfer, $offset, $limit);
    }
}
