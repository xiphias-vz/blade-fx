...
namespace Pyz\Zed\SalesOverviewCZ\Communication\Controller;

use Pyz\Zed\SalesOverview\Communication\Controller\IndexController as SalesOverviewIndexController;

class IndexController extends SalesOverviewIndexController
{
    protected const CONST_MERCHANT = '4007';
