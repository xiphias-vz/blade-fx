 ...
 */
class CashierFileFTPConsole extends Console
{
    public const COMMAND_NAME = 'monitor:cashier-file-ftp';
    public const COMMAND_DESCRIPTION = 'Check if the cashier files were exported to the FTP';
    ...
    {
        try {
            $this->getFacade()->checkCashierFilesOnFtp();
