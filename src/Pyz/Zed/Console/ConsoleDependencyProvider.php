...
use Pyz\Zed\DataImport\Communication\Console\DataImportExecSqlQueryConsole;
...
use Pyz\Zed\DataImport\Communication\Console\DataImportUpdateSalesOrderItemConsole;
...
class ConsoleDependencyProvider extends SprykerConsoleDependencyProvider
{
    ...
    protected function getConsoleCommands(Container $container)
    {
        $commands = [
            ...
            new DataImportConsole(DataImportConsole::DEFAULT_NAME . ':' . DataImportConfig::IMPORT_COUNTRY_LOCALIZED),
            new DataImportConsole(DataImportConsole::DEFAULT_NAME . ':' . DataImportConfig::IMPORT_UNIT_COMPARISON),
            ...
            new DataImportUpdateSalesOrderItemConsole(),
            ...
            new DataImportConsole(DataImportConsole::DEFAULT_NAME . ':' . SalesOrderThresholdDataImportConfig::IMPORT_TYPE_SALES_ORDER_THRESHOLD),

            // Spryker data importers
            ...
            new DatabaseLoadTestConsole(),

            new PerStoreInstallerConsole(),
