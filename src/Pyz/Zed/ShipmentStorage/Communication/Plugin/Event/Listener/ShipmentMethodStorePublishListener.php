 ...
 */
class ShipmentMethodStorePublishListener extends AbstractPlugin implements EventBulkHandlerInterface
{
    /**
    ...
    {
        $this->getFacade()->publishShipmentMethodStore($eventTransfers);
    }
}
