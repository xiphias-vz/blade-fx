 ...
 */
class ShipmentMethodPricesPublishListener extends AbstractPlugin implements EventBulkHandlerInterface
{
    /**
    ...
    {
        $this->getFacade()->publishShipmentMethodPrice($eventTransfers);
    }
}
