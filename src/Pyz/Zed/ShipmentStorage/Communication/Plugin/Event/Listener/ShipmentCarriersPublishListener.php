 ...
 */
class ShipmentCarriersPublishListener extends AbstractPlugin implements EventBulkHandlerInterface
{
    /**
    ...
    {
        $this->getFacade()->publishShipmentCarriers($eventTransfers);
    }
}
