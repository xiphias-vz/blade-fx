 ...
 */
class DataImportUpdateSalesOrderItemConsole extends Console
{
    public const COMMAND_NAME = 'import:updateSalesOrderItem';
    public const COMMAND_DESCRIPTION = 'Update sales order item from spy_sales_order_item';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            $sql = "call pyzx_update_sales_order_item;";
