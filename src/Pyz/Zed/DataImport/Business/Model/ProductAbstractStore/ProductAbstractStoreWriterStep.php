...
class ProductAbstractStoreWriterStep implements DataImportStepInterface
{
    ...
    {
        if (isset($dataSet[ProductAbstractWriterStep::IS_PRODUCT_CONCRETE]) && $dataSet[ProductAbstractWriterStep::IS_PRODUCT_CONCRETE]) {
            return;
        }
        ...
        foreach ($availableStores as $store) {
            (new SpyProductAbstractStoreQuery())
                ->filterByFkProductAbstract($this->getIdProductAbstractBySku(ProductAbstractWriterStep::getAbstractSku($dataSet)))
