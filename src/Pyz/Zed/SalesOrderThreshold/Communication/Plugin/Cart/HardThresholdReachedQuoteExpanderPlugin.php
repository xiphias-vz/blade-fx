 ...
 */
class HardThresholdReachedQuoteExpanderPlugin extends AbstractPlugin implements PostReloadItemsPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFacade()->expandWithHardThresholdReached($quoteTransfer);
    }
}
