 ...
 */
class MarkDeliveryCancelledByCustomerCommandPlugin extends AbstractPlugin implements CommandByOrderInterface
{
    /**
     * @api
     *
    ...
    public function run(array $orderItems, SpySalesOrder $orderEntity, ReadOnlyArrayObject $data): array
    {
        $orderUpdateRequestTransfer = (new OrderUpdateRequestTransfer())
            ->setStoreStatus(OmsConfig::STORE_STATE_DELIVERY_CANCELLED_BY_CUSTOMER);
