 ...
 */
class OrderStatusHydratorOrderPlugin extends AbstractPlugin implements HydrateOrderPluginInterface
{
    /**
    ...
    {
        return $this->getFacade()->hydrateSalesOrderStatus($orderTransfer);
    }
}
