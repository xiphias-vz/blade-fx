...
use Spryker\Zed\CmsGui\Communication\Controller\VersionPageController as SprykerVersionPageController;
 ...
 */
class VersionPageController extends SprykerVersionPageController
{
    /**
     * @param string $url
     * @param int $status
