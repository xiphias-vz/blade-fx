...
class PostalCodeConstraintValidator extends ConstraintValidator
{
    /**
     * @param mixed $value
     * @param \Pyz\Zed\Customer\Communication\Form\Constraints\PostalCodeConstraint $constraint
     *
    ...
    public function validate($value, Constraint $constraint)
    {
        ...
        $customerAddressResponseTransfer = $constraint->getCustomerFacade()->isPostalCodeWhiteListed($customerAddressRequestTransfer);
