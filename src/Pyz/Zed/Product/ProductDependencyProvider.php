...
use Pyz\Zed\CategoryPageSearch\Communication\Plugin\CategoryNodeProductAbstractAfterUpdatePlugin;
use Pyz\Zed\CategoryPageSearch\Communication\Plugin\CategoryNodeProductConcreteAfterUpdatePlugin;
use Pyz\Zed\NavigationStorage\Communication\Plugin\NavigationStorageProductAbstractAfterUpdatePlugin;
use Pyz\Zed\NavigationStorage\Communication\Plugin\NavigationStorageProductConcreteAfterUpdatePlugin;
use Pyz\Zed\ProductQuantityGui\Communication\Plugin\Product\SaveProductQuantityProductConcretePluginUpdatePlugin;
...
class ProductDependencyProvider extends SprykerProductDependencyProvider
{
    ...
    protected function getProductAbstractAfterUpdatePlugins(Container $container)
    {
        return [
            ...
            new NavigationStorageProductAbstractAfterUpdatePlugin(),
            new CategoryNodeProductAbstractAfterUpdatePlugin(),
        ];
    }
    ...
    protected function getProductConcreteAfterUpdatePlugins(Container $container)
    {
        return [
            ...
            new SaveProductQuantityProductConcretePluginUpdatePlugin(), #ProductQuantityFeature
            new NavigationStorageProductConcreteAfterUpdatePlugin(),
            new CategoryNodeProductConcreteAfterUpdatePlugin(),
        ];
    }
}
