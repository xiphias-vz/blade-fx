...
class GlobusRestApiAddressResult
{
    ...
    public function getSettings(): array
    {
        ...
        'we' => true,
        'showOverlay' => false,
                'addressSelection' => 'NONE', 'showWeHint' => true, 'showScanAndGoActivateHint' => false,
                'showScanAndGoNotActivateHint' => true],
            [
            'code' => 'UN',
            'display' => false,
            'mainGlobus' => false,
            ...
            'we' => true,
            'showOverlay' => true,
                'addressSelection' => 'USER', 'showWeHint' => true, 'showScanAndGoActivateHint' => false,
                'showScanAndGoNotActivateHint' => true],
            [
            'code' => 'NV',
            'display' => true,
            ...
            'we' => false,
            'showOverlay' => true,
                'addressSelection' => 'USER', 'showWeHint' => false, 'showScanAndGoActivateHint' => false,
                'showScanAndGoNotActivateHint' => true],
            [
            'code' => 'NV',
            'display' => true,
            ...
            'we' => true,
            'showOverlay' => true,
                'addressSelection' => 'API', 'showWeHint' => true, 'showScanAndGoActivateHint' => false,
                'showScanAndGoNotActivateHint' => true],
            [
            'code' => 'NV',
            'display' => true,
            ...
            'we' => false,
            'showOverlay' => true,
                'addressSelection' => 'API', 'showWeHint' => false, 'showScanAndGoActivateHint' => false,
                'showScanAndGoNotActivateHint' => true],
            [
            'code' => 'VA',
            'display' => false,
            ...
            'we' => true,
            'showOverlay' => false,
                'addressSelection' => 'NONE', 'showWeHint' => true, 'showScanAndGoActivateHint' => true,
                'showScanAndGoNotActivateHint' => false],
            [
            'code' => 'VZ',
            'display' => false,
            'mainGlobus' => false,
            ...
            'we' => true,
            'showOverlay' => true,
                'addressSelection' => 'API', 'showWeHint' => true, 'showScanAndGoActivateHint' => true,
                'showScanAndGoNotActivateHint' => false],
            [
            'code' => 'VZ',
            'display' => true,
