...
import { EVENT_ELEMENT_IN_VIEWPORT } from '../viewport-intersection-observer/viewport-intersection-observer.ts';

export default class LazyImageBannerGrid extends Component {
