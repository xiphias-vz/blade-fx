...
export default class NavOverlay extends Component {
    ...
    protected init(): void {
        this.navigation = <HTMLElement>document.getElementsByClassName(this.navClass)[0];
    ...
    protected toggleActiveNavClass(isActive: boolean): void {
    ...
    protected get navActiveClass(): string {
